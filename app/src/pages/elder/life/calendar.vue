...
<style scoped>
.calendar-page { position: relative; min-height: 100vh; padding: calc(env(safe-area-inset-top) + 16px) 20px calc(env(safe-area-inset-bottom) + 28px); overflow: auto; background: radial-gradient(circle at 84% 6%,rgba(245,218,157,.5),transparent 27%),linear-gradient(160deg,#f9f3e8 0%,var(--sg-background) 58%,#efe4d1 100%); }
...
.page-header { position:relative; z-index:1; display:grid; grid-template-columns:48px 1fr 48px; align-items:center; min-height:48px; animation:calendar-rise var(--sg-motion-emphasized) var(--sg-ease-emphasized) both; }
...
.month-card { position:relative; z-index:1; margin-top:18px; padding:18px 14px 15px; border:1px solid var(--sg-border); border-radius:24px; background:linear-gradient(155deg,rgba(255,253,248,.98),rgba(244,234,216,.96)); box-shadow:var(--sg-shadow),inset 0 1px var(--sg-highlight); animation:calendar-rise var(--sg-motion-emphasized) 45ms var(--sg-ease-emphasized) both; }
.month-toolbar { display:flex; align-items:center; justify-content:space-between; padding:0 3px 14px; }
...
.selected-heading { position:relative; z-index:1; display:flex; align-items:center; justify-content:space-between; margin:24px 2px 12px; animation:calendar-rise var(--sg-motion-emphasized) 90ms var(--sg-ease-emphasized) both; }
...
.schedule-list { position:relative; z-index:1; display:flex; flex-direction:column; gap:10px; animation:calendar-rise var(--sg-motion-emphasized) 130ms var(--sg-ease-emphasized) both; }
.schedule-item { display:flex; align-items:center; min-height:68px; padding:11px 14px; border:1px solid var(--sg-border); border-radius:19px; background:linear-gradient(155deg,rgba(255,253,248,.97),rgba(244,234,216,.95)); box-shadow:var(--sg-shadow-soft),inset 0 1px var(--sg-highlight); }
...
.empty-card { position:relative; z-index:1; display:flex; align-items:center; min-height:74px; padding:13px 15px; border:1px solid var(--sg-border); border-radius:20px; background:linear-gradient(155deg,rgba(255,253,248,.97),rgba(244,234,216,.95)); box-shadow:var(--sg-shadow-soft),inset 0 1px var(--sg-highlight); animation:calendar-rise var(--sg-motion-emphasized) 130ms var(--sg-ease-emphasized) both; }
...
.demo-note { position:relative; z-index:1; display:block; margin-top:15px; color:var(--sg-secondary); font-size:12px; text-align:center; }
