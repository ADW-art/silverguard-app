...
.torch-icon { position:relative; display:grid; place-items:center; width:156px; height:156px; border:1px solid rgba(128,89,31,.16); border-radius:50% 50% 43% 43%; color:var(--sg-gold-deep); background:radial-gradient(circle at 34% 24%,rgba(255,255,255,.76),transparent 32%),linear-gradient(145deg,#fff5d7,#e8c474); box-shadow:0 26px 56px rgba(91,64,29,.17),inset 0 1px rgba(255,255,255,.64); transition:transform var(--sg-motion-emphasized) var(--sg-ease-emphasized),box-shadow var(--sg-motion-standard) ease; }
